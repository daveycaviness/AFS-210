...
# Im not too familiar with this algorithm at all so I had to get help
# from a class mate that really didnt know much about the algorithm either
# but what I took away from this assigment is that the first pivotal element
# is the most accurate and using the last pivotal element is the least accurate. 
# I wish we were given more insight into merge sort algorithms and how to use 
# the algorithm and the use cases which i feel like i know of some use cases in
# it like for making a random drawings for like a jackpot or a prize. 